...
void main() {
  group('CifraScrollConfig', () {
    test('velocidade inicial é o valor padrão', () {
      const config = CifraScrollConfig();
    ...
    test('aumentar fonte respeita o limite máximo', () {
      const config = CifraScrollConfig(fontSize: CifraScrollConfig.fontSizeMax);
    ...
    test('diminuir fonte respeita o limite mínimo', () {
      const config = CifraScrollConfig(fontSize: CifraScrollConfig.fontSizeMin);
    ...
    test('aumentar fonte incrementa 1.0', () {
      const config = CifraScrollConfig(fontSize: 14.0);
    ...
    test('aumentar velocidade respeita o limite máximo', () {
      const config = CifraScrollConfig(velocidade: CifraScrollConfig.velocidadeMax);
    ...
    test('diminuir velocidade respeita o limite mínimo', () {
      const config = CifraScrollConfig(velocidade: CifraScrollConfig.velocidadeMin);
